...
% Equation 1
\begin{dmath}
{{N}}_{t}^{\frac{1}{{\nu}}}\, \exp\left({{\theta_N}}_{t}\right)\, \frac{\left(1-{{\phi}}\right)\, \frac{{(labor share)}}{{N\_ss}}}{{N\_ss}^{\frac{1}{{\nu}}}\, {\mu_{ss}}}=\frac{\left(1-{{\phi}}\right)\, {W\_C}_{t}}{{\mu_{ss}}\, \exp\left({{\mu_C}}_{t}\right)}
\end{dmath}
% Equation 2
\begin{dmath}
\frac{{W\_C}_{t}}{{\mu_{ss}}\, \exp\left({{\mu_C}}_{t}\right)}=\frac{{W\_I}_{t}}{{\mu_{ss}}\, \exp\left({\mu_I}}_{t}\right)}
\end{dmath}
% Equation 3
\begin{dmath}
...
% Equation 53
\begin{dmath}
{{W}}_{t}={W\_C}_{t}\, \frac{{{N_C}}_{t}}{{{N}}_{t}}+{W\_I}_{t}\, \frac{{{N_I}}_{t}}{{{N}}_{t}}
\end{dmath}
% Equation 54
\begin{dmath}
