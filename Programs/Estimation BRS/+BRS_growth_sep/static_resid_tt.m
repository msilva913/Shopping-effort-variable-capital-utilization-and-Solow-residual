...
T(14) = 1+1/params(11);
T(15) = (1-T(3))*params(8)/params(19)*(1-params(6)-(T(6))^T(14)/T(14))^(-params(1))/params(19)^(1/params(5))*exp(y(13));
T(16) = y(7)^(1/params(5))*T(15);
T(17) = y(21)^(-params(1));
T(18) = exp(y(14))*y(18)^(1/params(11));
T(19) = exp(y(14))*y(18)^T(14)/T(14);
T(20) = exp(y(23))^(-params(1));
T(21) = 1-(1+params(6)/params(7)-exp(params(4)));
T(22) = T(2)*((1-T(3))*y(15)+y(22)*T(21));
T(23) = T(7)*y(19)^T(3);
T(24) = exp(y(23))^(-T(5));
T(25) = exp(y(10))*T(12)*T(24);
T(26) = y(5)^T(5);
T(27) = T(25)*T(26);
T(28) = y(8)^T(4);
T(29) = T(8)*y(20)^T(3);
T(30) = exp(y(12))*T(13)*T(24);
T(31) = y(6)^T(5);
T(32) = T(30)*T(31);
T(33) = y(9)^T(4);
