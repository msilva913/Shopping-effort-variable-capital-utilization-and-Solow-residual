...
T(20) = T(6)*params(10)/params(24)/T(16)*exp(y(14));
T(21) = exp(y(15))*y(29)^(1/params(13));
T(22) = 1+1/params(13);
T(23) = exp(y(15))*y(29)^T(22)/T(22);
T(24) = 1+1/params(5);
T(25) = y(10)^T(24);
T(26) = y(35)^2;
T(27) = T(3)*exp(y(38))^(-params(1));
T(28) = (T(1)+T(2))*params(6)/2;
T(29) = y(30)^T(4);
T(30) = T(9)*T(29);
T(31) = exp(y(38))^(-T(5));
T(32) = exp(y(11))*T(14)*T(31);
T(33) = (y(21)*y(5))^T(5);
T(34) = y(8)^T(7);
T(35) = y(31)^T(4);
T(36) = T(10)*T(35);
T(37) = exp(y(13))*T(15)*T(31);
T(38) = (y(22)*y(6))^T(5);
T(39) = y(9)^T(7);
T(40) = T(29)*T(9)*y(2)/y(1);
T(41) = T(40)*(T(33)*T(34)-T(11));
T(42) = y(5)^T(5);
T(43) = T(34)*T(42)-T(11);
T(44) = T(35)*T(10)*y(3)/y(1);
T(45) = T(44)*(T(38)*T(39)-T(12));
T(46) = y(6)^T(5);
T(47) = T(39)*T(46)-T(12);
