...
if T_flag
    T = SU_util.static_g1_tt(T, y, x, params);
end
g1 = zeros(53, 53);
...
g1(5,22)=y(23)*T(41)-T(16)*T(18)*T(41);
...
g1(7,11)=(-(T(19)*T(24)));
g1(7,20)=(-(T(19)*T(23)*T(21)*exp(y(11))*T(6)*T(39)));
g1(7,24)=(-(T(19)*T(23)*exp(y(11))*T(6)*T(20)*T(42)));
g1(8,3)=1;
g1(8,7)=(-(T(25)*T(27)*getPowerDeriv(y(7),T(1),1)));
g1(8,10)=(-(T(29)*getPowerDeriv(y(10),(1-params(8))*params(7),1)));
g1(8,13)=(-(T(25)*T(29)));
g1(8,21)=(-(T(25)*T(28)*T(21)*exp(y(13))*T(7)*T(40)));
g1(8,24)=(-(T(25)*T(28)*exp(y(13))*T(7)*T(26)*T(42)));
g1(9,3)=exp(y(24));
...
g1(17,2)=(-1);
g1(17,3)=(-params(16));
g1(18,1)=(-(T(30)*(y(2)*(-y(2))/(y(1)*y(1))/T(33)+y(3)*(-y(3))/(y(1)*y(1))/T(36))));
g1(18,2)=(-(T(30)*(y(2)/y(1)+y(2)*1/y(1))/T(33)));
g1(18,3)=(-(T(30)*(y(3)/y(1)+y(3)*1/y(1))/T(36)));
g1(18,4)=1;
g1(18,6)=(-(T(30)*(-(y(2)*y(2)/y(1)*T(32)*getPowerDeriv(y(6),1-params(7),1)))/(T(33)*T(33))));
g1(18,7)=(-(T(30)*(-(y(3)*y(3)/y(1)*T(35)*getPowerDeriv(y(7),1-params(7),1)))/(T(36)*T(36))));
g1(18,9)=(-(T(30)*(-(y(2)*y(2)/y(1)*T(31)*getPowerDeriv(y(9),params(7),1)))/(T(33)*T(33))));
g1(18,10)=(-(T(30)*(-(y(3)*y(3)/y(1)*T(34)*getPowerDeriv(y(10),params(7),1)))/(T(36)*T(36))));
g1(18,24)=(-(T(37)*exp(y(24))*getPowerDeriv(exp(y(24)),1-params(7),1)));
g1(19,20)=(-T(39));
g1(19,25)=1;
g1(20,21)=(-T(40));
g1(20,26)=1;
