...
T(2) = 1/params(4);
T(3) = exp(y(29))*y(33)^(1/params(9));
T(4) = 1+1/params(9);
T(5) = exp(y(29))*y(33)^T(4)/T(4);
T(6) = y(36)^(-params(1));
T(7) = y(58)^(-params(1));
T(8) = exp(y(60))^(-params(1));
T(9) = y(23)^((1-params(8))*params(7));
T(10) = y(24)^((1-params(8))*params(7));
...
T(17) = exp(y(28))*(1-params(8))*params(5)*(1-params(8))*params(7)*params(16)/(1-params(8))/(params(5)*params(17))/params(17)^T(2);
T(18) = y(22)^T(2)*T(17);
T(19) = y(22)^(1+T(2))*T(17)/(1+T(2));
T(20) = 1-(1+params(5)/params(6)-exp(params(3)));
T(21) = params(2)*((1-params(8))*y(56)+y(59)*T(20));
T(22) = exp(y(25))*T(15)*y(34)^params(8)*T(12);
T(23) = exp(y(38))^(-T(11));
T(24) = T(22)*T(23);
T(25) = y(1)^T(11);
T(26) = T(24)*T(25);
T(27) = exp(y(27))*T(16)*y(35)^params(8)*T(13);
T(28) = T(23)*T(27);
T(29) = y(2)^T(11);
T(30) = T(28)*T(29);
