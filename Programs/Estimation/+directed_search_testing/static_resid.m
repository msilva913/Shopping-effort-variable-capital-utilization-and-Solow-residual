...
residual(34) = lhs - rhs;
lhs = y(34);
rhs = (params(19)+params(20))*y(34)+params(20)*(-params(19))*y(34)-x(4);
residual(35) = lhs - rhs;
lhs = y(36);
rhs = y(8)-y(1);
residual(36) = lhs - rhs;
...
residual(40) = lhs - rhs;
lhs = y(41);
rhs = y(35)-(1-params(9))*y(26)-params(9)*y(23);
residual(41) = lhs - rhs;
lhs = y(43);
rhs = y(44)-(1-params(9))*y(26)-params(9)*y(23);
residual(42) = lhs - rhs;
lhs = y(39);
rhs = y(35)-y(23);
residual(43) = lhs - rhs;
