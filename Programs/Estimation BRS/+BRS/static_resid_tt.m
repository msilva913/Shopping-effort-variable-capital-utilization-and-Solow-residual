...
T(12) = y(7)^T(10)*T(11);
T(13) = 1/params(9);
T(14) = exp(y(14))*y(18)^T(13);
T(15) = 1+T(13);
T(16) = exp(y(14))*y(18)^T(15)/T(15);
T(17) = T(11)*y(7)^(1+T(10))/(1+T(10));
T(18) = y(21)^(-params(1));
T(19) = y(8)^((1-params(8))*params(7));
T(20) = exp(y(10))*T(8)*T(6)*y(19)^params(8);
T(21) = y(5)^T(4);
T(22) = T(20)*T(21);
T(23) = y(9)^((1-params(8))*params(7));
T(24) = exp(y(12))*T(9)*T(7)*y(20)^params(8);
T(25) = y(6)^T(4);
T(26) = T(24)*T(25);
T(27) = (1-params(8))*params(7)/T(4);
