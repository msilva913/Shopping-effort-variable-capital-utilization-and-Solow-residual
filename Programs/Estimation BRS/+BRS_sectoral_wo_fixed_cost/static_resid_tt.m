...
T(23) = (1-params(18))*params(15)/params(32)/(params(8)*((1-params(13))*(1-params(17))-(T(6))^T(17)/T(17))*params(32)^T(18))*exp(y(23));
T(24) = y(19)^T(18)*T(23);
T(25) = (y(18)/y(19))^params(21);
T(26) = (1-params(7))*y(57)^(-params(6));
T(27) = params(7)*y(58)^(-params(6));
T(28) = exp(y(24))*y(51)^(1/params(19));
T(29) = exp(y(24))*y(51)^T(17)/T(17);
T(30) = y(2)-params(17)*y(2)-T(29);
T(31) = T(23)*y(19)^(1+T(18))/(1+T(18));
T(32) = y(56)*T(31);
T(33) = T(30)^params(5);
T(34) = y(56)^(1-params(5));
T(35) = params(7)^(1-T(3));
...
T(39) = exp(y(72));
T(40) = T(2)*params(9)/2;
T(41) = params(2)*exp(y(26))*T(39)^(-params(1));
T(42) = y(64)^2;
T(43) = y(48)*y(61)*T(41)*T(42);
T(44) = y(65)^2;
T(45) = y(49)*T(41)*y(62)*T(44);
T(46) = y(66)^2;
T(47) = y(50)*T(41)*y(63)*T(46);
T(48) = T(7)*y(52)^params(18);
T(49) = y(15)^T(5);
T(50) = T(39)^(-T(4));
...
T(78) = y(18)^params(15);
T(79) = T(77)*T(78);
T(80) = y(3)*T(67)/T(73)+y(4)*T(68)/T(76)+y(6)*T(69)/T(79);
T(81) = y(11)^T(4);
T(82) = T(51)*T(81);
T(83) = T(49)*T(82)-T(10);
T(84) = y(12)^T(4);
