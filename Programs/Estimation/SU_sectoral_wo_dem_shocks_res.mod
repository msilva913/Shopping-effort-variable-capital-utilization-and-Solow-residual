...
[name='Shopping:mc']
D^(1/eta) = phi*p_mc*Y_mc/D_mc;

[name='Shopping:sc']
D^(1/eta) = phi*p_sc*Y_sc/D_sc;
...
rho_N,  0.99, 0.01, 0.9999,        BETA_PDF, 0.6, 0.2;
...
mode_file=SU_sectoral_wo_dem_shocks_res_mh_mode, %With _mh option uses mode after MCM run
//nograph,
load_mh_file, 
//mh_recover,
