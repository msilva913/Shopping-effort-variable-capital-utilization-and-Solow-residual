...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(1,1)=5; nzij_pred(1,2)=2;
  nzij_pred(2,1)=6; nzij_pred(2,2)=2;
  nzij_pred(3,1)=2; nzij_pred(3,2)=3;
  nzij_pred(4,1)=3; nzij_pred(4,2)=4;
  nzij_pred(5,1)=6; nzij_pred(5,2)=4;
  nzij_current = zeros(16, 2, 'int32');
  ...
  nzij_current(8,1)=5; nzij_current(8,2)=5;
  nzij_current(9,1)=7; nzij_current(9,2)=5;
  nzij_current(10,1)=2; nzij_current(10,2)=6;
  nzij_current(11,1)=3; nzij_current(11,2)=6;
  nzij_current(12,1)=4; nzij_current(12,2)=6;
  nzij_current(13,1)=1; nzij_current(13,2)=7;
  ...
  nzij_fwrd(3,1)=4; nzij_fwrd(3,2)=6;
  nzij_fwrd(4,1)=2; nzij_fwrd(4,2)=7;
  nzij_fwrd(5,1)=4; nzij_fwrd(5,2)=7;
end
