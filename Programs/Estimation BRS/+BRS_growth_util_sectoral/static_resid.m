...
if T_flag
    T = BRS_growth_util_sectoral.static_resid_tt(T, y, x, params);
end
residual = zeros(62, 1);
lhs = y(10);
...
residual(5) = lhs - rhs;
lhs = y(33);
rhs = exp(y(17))*(y(2)-y(2)*params(12))-T(26)-T(27);
residual(6) = lhs - rhs;
lhs = y(28);
...
residual(18) = lhs - rhs;
lhs = y(2);
rhs = T(32)*(T(34)*T(35)*T(36)-T(11));
residual(19) = lhs - rhs;
lhs = y(3);
rhs = T(38)*(T(39)*T(40)*T(41)-T(12));
residual(20) = lhs - rhs;
lhs = exp(y(39))*y(3)*(1-y(28));
rhs = exp(y(39))*(y(5)+y(6))-(1-y(24))*y(5)-(1-y(25))*y(6);
residual(21) = lhs - rhs;
lhs = T(6)*y(20);
rhs = T(7)*(y(2)+T(11)*T(32))/y(8);
residual(22) = lhs - rhs;
lhs = T(6)*y(21)/y(34);
rhs = T(7)*(y(3)+T(12)*T(38))/y(9);
residual(23) = lhs - rhs;
lhs = T(6)*y(18);
rhs = (y(2)+T(11)*T(32))*T(5)*exp(y(39))/(y(22)*y(5));
residual(24) = lhs - rhs;
lhs = T(6)*y(19)/y(34);
rhs = (y(3)+T(12)*T(38))*T(5)*exp(y(39))/(y(23)*y(6));
residual(25) = lhs - rhs;
lhs = y(7);
rhs = y(8)+y(9);
residual(26) = lhs - rhs;
