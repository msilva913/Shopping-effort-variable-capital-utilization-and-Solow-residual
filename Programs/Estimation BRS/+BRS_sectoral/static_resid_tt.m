...
T(26) = (1-params(7))*y(56)^(-params(6));
T(27) = params(7)*y(57)^(-params(6));
T(28) = exp(y(23))*y(50)^(1/params(19));
T(29) = exp(y(23))*y(50)^T(17)/T(17);
T(30) = y(2)-params(17)*y(2)-T(29);
T(31) = T(23)*y(18)^(1+T(18))/(1+T(18));
T(32) = y(55)*T(31);
T(33) = T(30)^params(5);
T(34) = y(55)^(1-params(5));
T(35) = params(7)^(1-T(3));
...
T(42) = y(63)^2;
T(43) = y(47)*y(60)*T(41)*T(42);
T(44) = y(64)^2;
T(45) = y(48)*T(41)*y(61)*T(44);
T(46) = y(65)^2;
T(47) = y(49)*T(41)*y(62)*T(46);
T(48) = T(7)*y(51)^params(18);
T(49) = y(14)^T(5);
T(50) = T(39)^(-T(4));
...
T(55) = T(8)*y(52)^params(18);
T(56) = y(15)^T(5);
T(57) = exp(y(19))*T(15)*T(50);
T(58) = (y(35)*y(11))^T(4);
T(59) = T(57)*T(58);
T(60) = T(55)*(T(56)*T(59)-T(11));
T(61) = T(9)*y(53)^params(18);
T(62) = y(17)^T(5);
T(63) = exp(y(21))*T(16)*T(50);
T(64) = (y(36)*y(12))^T(4);
T(65) = T(63)*T(64);
