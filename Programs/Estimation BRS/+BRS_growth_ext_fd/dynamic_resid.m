...
if T_flag
    T = BRS_growth_ext_fd.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(43, 1);
lhs = T(23);
...
residual(37) = lhs - rhs;
lhs = y(51);
rhs = y(42)+y(45)-y(9)-params(3);
residual(38) = lhs - rhs;
lhs = y(52);
rhs = y(42)+y(46)-y(10)-params(3);
residual(39) = lhs - rhs;
lhs = y(53);
rhs = y(42)+y(44)-y(8)-params(3);
residual(40) = lhs - rhs;
lhs = y(54);
rhs = y(42)+y(48)-y(12)-params(3);
residual(41) = lhs - rhs;
lhs = y(55);
rhs = y(50)-y(13);
residual(42) = lhs - rhs;
