...
M_.endo_names(28) = {'log_NC'};
M_.endo_names_tex(28) = {'log\_NC'};
M_.endo_names_long(28) = {'log_NC'};
M_.endo_names(29) = {'log_NI'};
M_.endo_names_tex(29) = {'log\_NI'};
M_.endo_names_long(29) = {'log_NI'};
M_.endo_names(30) = {'log_Y_N'};
M_.endo_names_tex(30) = {'log\_Y\_N'};
M_.endo_names_long(30) = {'log_Y_N'};
M_.endo_names(31) = {'log_D'};
M_.endo_names_tex(31) = {'log\_D'};
M_.endo_names_long(31) = {'log_D'};
M_.endo_names(32) = {'log_p_I'};
M_.endo_names_tex(32) = {'log\_p\_I'};
M_.endo_names_long(32) = {'log_p_I'};
M_.endo_names(33) = {'C_obs'};
M_.endo_names_tex(33) = {'C\_obs'};
M_.endo_names_long(33) = {'C_obs'};
M_.endo_names(34) = {'I_obs'};
M_.endo_names_tex(34) = {'I\_obs'};
M_.endo_names_long(34) = {'I_obs'};
M_.endo_names(35) = {'Y_obs'};
M_.endo_names_tex(35) = {'Y\_obs'};
M_.endo_names_long(35) = {'Y_obs'};
M_.endo_names(36) = {'Y_N_obs'};
M_.endo_names_tex(36) = {'Y\_N\_obs'};
M_.endo_names_long(36) = {'Y_N_obs'};
M_.endo_names(37) = {'p_I_obs'};
M_.endo_names_tex(37) = {'p\_I\_obs'};
M_.endo_names_long(37) = {'p_I_obs'};
M_.endo_names(38) = {'NC_obs'};
M_.endo_names_tex(38) = {'NC\_obs'};
M_.endo_names_long(38) = {'NC_obs'};
M_.endo_names(39) = {'NI_obs'};
M_.endo_names_tex(39) = {'NI\_obs'};
M_.endo_names_long(39) = {'NI_obs'};
M_.endo_names(40) = {'N_obs'};
M_.endo_names_tex(40) = {'N\_obs'};
M_.endo_names_long(40) = {'N_obs'};
...
options_.varobs_id = [ 34 35 37 36  ];
M_ = setup_solvers(M_);
...
M_.equations_tags = {
  ...
  18 , 'name' , 'exogenous labor-augmenting growth process' ;
  ...
  28 , 'name' , 'log_NC' ;
  29 , 'name' , 'log_NI' ;
  30 , 'name' , 'Definition log labor productivity' ;
  31 , 'name' , 'Definition log shopping effort' ;
  32 , 'name' , 'Definition of log relative investment  price' ;
  33 , 'name' , 'C_obs' ;
  34 , 'name' , 'I_obs' ;
  35 , 'name' , 'Y_obs' ;
  36 , 'name' , 'Y_N_obs' ;
...
M_.mapping.N_C.eqidx = [7 10 14 28 ];
M_.mapping.N_I.eqidx = [8 12 14 29 ];
...
M_.mapping.D.eqidx = [2 3 4 16 31 ];
M_.mapping.D_C.eqidx = [2 7 16 ];
M_.mapping.D_I.eqidx = [3 8 16 ];
M_.mapping.Gam.eqidx = [4 5 ];
M_.mapping.p_I.eqidx = [3 5 12 13 32 ];
M_.mapping.g.eqidx = [5 7 8 9 11 13 18 33 34 35 36 ];
M_.mapping.log_Y.eqidx = [24 30 35 ];
M_.mapping.log_C.eqidx = [25 33 ];
M_.mapping.log_I.eqidx = [26 34 ];
M_.mapping.log_N.eqidx = [27 30 38 ];
M_.mapping.log_NC.eqidx = [28 39 ];
M_.mapping.log_NI.eqidx = [29 40 ];
M_.mapping.log_Y_N.eqidx = [30 36 ];
M_.mapping.log_D.eqidx = [31 ];
M_.mapping.log_p_I.eqidx = [32 37 ];
M_.mapping.C_obs.eqidx = [33 ];
M_.mapping.I_obs.eqidx = [34 ];
M_.mapping.Y_obs.eqidx = [35 ];
M_.mapping.Y_N_obs.eqidx = [36 ];
M_.mapping.p_I_obs.eqidx = [37 ];
M_.mapping.NC_obs.eqidx = [39 ];
M_.mapping.NI_obs.eqidx = [40 ];
M_.mapping.N_obs.eqidx = [38 ];
...
M_.state_var = [5 6 10 12 13 14 23 24 25 26 27 28 29 30 32 ];
...
options_.order = 1;
options_.periods = 0;
var_list_ = {'Y_obs';'Y_N_obs';'I_obs';'p_I_obs';'C_obs';'NC_obs';'NI_obs'};
