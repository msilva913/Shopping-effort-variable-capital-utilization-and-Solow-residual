...
T(5) = y(177)^(-params(1));
T(6) = y(144)^T(4);
T(7) = (y(142)/y(144))^params(21);
T(8) = (y(143)/y(144))^params(21);
T(9) = exp(y(149))*y(173)^(1/params(19));
T(10) = exp(y(149))*y(173)^T(3)/T(3);
T(11) = y(129)-params(17)*y(1)-T(10);
T(12) = T(11)^params(5);
T(13) = y(15)^(1-params(5));
T(14) = exp(y(335))^(-params(1));
T(15) = params(2)*exp(y(151))*y(330)/y(184)*T(14);
T(16) = y(333)^2;
T(17) = T(15)*y(331)*y(328)*T(16);
T(18) = y(334)^2;
T(19) = T(15)*y(332)*y(329)*T(18);
T(20) = 1-T(2);
T(21) = (1-params(7))^T(20);
T(22) = params(7)^T(20);
T(23) = T(22)*y(131)^T(2)+T(21)*y(130)^T(2);
...
T(42) = y(142)^(1+params(21))*T(40)+y(143)^(1+params(21))*T(41);
T(43) = T(6)*exp(y(148))*T(5)*T(39);
T(44) = y(144)^(1+T(4))*exp(y(148))*T(39)/(1+T(4));
T(45) = y(178)*T(44);
T(46) = params(9)*T(25)/2;
T(47) = y(174)^T(1)*T(29);
T(48) = exp(y(193))^(-T(26));
T(49) = exp(y(145))*T(36)*T(48);
T(50) = (y(160)*y(4))^T(26);
T(51) = T(49)*T(50);
T(52) = y(140)^T(27);
T(53) = T(47)*(T(51)*T(52)-T(32));
T(54) = y(175)^T(1)*T(30);
T(55) = exp(y(145))*T(37)*T(48);
T(56) = (y(161)*y(5))^T(26);
T(57) = T(55)*T(56);
T(58) = y(141)^T(27);
T(59) = y(176)^T(1)*T(31);
T(60) = exp(y(147))*T(38)*T(48);
T(61) = (y(162)*y(6))^T(26);
T(62) = T(60)*T(61);
T(63) = y(143)^T(27);
