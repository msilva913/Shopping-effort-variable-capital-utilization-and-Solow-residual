...
T(19) = y(16)^(1+params(19))*T(17)+y(17)^(1+params(19))*T(18);
T(20) = (y(16)/y(18))^params(19);
T(21) = (1-params(16))*params(13)/params(30)/(params(8)*((1-params(11))*(1-params(15))-(T(4))^T(15)/T(15))*params(30)^T(16))*exp(y(22));
T(22) = y(18)^T(16)*T(21);
T(23) = (y(17)/y(18))^params(19);
T(24) = (1-params(7))*y(46)^(-params(6));
T(25) = params(7)*y(47)^(-params(6));
T(26) = exp(y(23))*y(40)^(1/params(17));
T(27) = exp(y(23))*y(40)^T(15)/T(15);
T(28) = y(2)-params(15)*y(2)-T(27);
T(29) = T(21)*y(18)^(1+T(16))/(1+T(16));
T(30) = y(45)*T(29);
T(31) = T(28)^params(5);
T(32) = y(45)^(1-params(5));
T(33) = params(7)^(1-T(1));
T(34) = (1-params(7))^(1-T(1));
T(35) = T(33)*y(4)^T(1)+T(34)*y(3)^T(1);
T(36) = params(9)/2;
T(37) = exp(y(60));
T(38) = params(2)*exp(y(25))*T(37)^(-params(1));
T(39) = y(53)^2;
T(40) = y(37)*y(50)*T(38)*T(39);
T(41) = y(54)^2;
T(42) = y(38)*T(38)*y(51)*T(41);
T(43) = y(55)^2;
T(44) = y(39)*T(38)*y(52)*T(43);
T(45) = 1-(1+params(11)/params(12)-exp(params(3)));
T(46) = T(5)*y(41)^params(16);
T(47) = y(14)^T(3);
T(48) = T(37)^(-T(2));
T(49) = exp(y(19))*T(12)*T(48);
T(50) = y(10)^T(2);
T(51) = T(49)*T(50);
T(52) = T(6)*y(42)^params(16);
T(53) = y(15)^T(3);
T(54) = exp(y(19))*T(13)*T(48);
T(55) = y(11)^T(2);
T(56) = T(54)*T(55);
T(57) = T(7)*y(43)^params(16);
T(58) = y(17)^T(3);
T(59) = exp(y(21))*T(14)*T(48);
T(60) = y(12)^T(2);
T(61) = T(59)*T(60);
