...
%%%%%%%%%%%%%%%%%%%%
varobs C_obs, TI_obs, lab_prod_obs;
...
% Gross markup
Gamma_bar, 1.2, 1.01, 2.0,    BETA_PDF, 1.3, 0.20, 1.01, 2.0;

% Elasticity parameter matching function
gam, 0.05, 0.01, 2.0,          BETA_PDF, 0.42, 0.3, 0.0, 2.0;

% Adjustment costs
Psi_K, 1.0, 0.00, 30,        GAMMA_PDF, 1.57, 1.5;
...
rho_kappa, 0.8, 0.0212, 0.9999,     BETA_PDF, 0.6, 0.2;
rho_zeta, 0.8, 0.0212, 0.9999,     BETA_PDF, 0.6, 0.2;
...
stderr e_Z, 0.01, 0.0001, 0.2,  INV_GAMMA_PDF, 0.01, 0.004;

% Shopping demand: sector-specific and common
stderr e_kappa, 0.01, 0.0001, 0.6,  INV_GAMMA_PDF, 0.01, 0.004;
stderr e_zeta, 0.02, 0.0001, 0.6,  INV_GAMMA_PDF, 0.01, 0.004;
...
//mode_file=directed_search_est_alt_obs_mode, 
//load_mh_file, 
//mh_recover,
