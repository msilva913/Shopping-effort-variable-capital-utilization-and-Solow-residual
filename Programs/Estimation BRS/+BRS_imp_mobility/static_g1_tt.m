...
T(41) = getPowerDeriv(y(20)*y(5),params(8)*(T(1)+T(2)),1);
T(42) = getPowerDeriv(y(21)*y(6),params(8)*(T(1)+T(2)),1);
...
T(46) = exp(y(15))*getPowerDeriv(y(26),1/params(11),1);
T(47) = exp(y(15))*getPowerDeriv(y(26),T(19),1)/T(19);
T(48) = getPowerDeriv(y(27),T(4),1);
T(49) = getPowerDeriv(y(28),T(4),1);
T(50) = params(6)/2*2*(y(33)-params(7)/params(8));
T(51) = (-(T(26)*y(32)*(params(6)*(y(33)-params(7)/params(8))+params(6)*y(33)-T(50))));
T(52) = T(3)*exp(y(35))*getPowerDeriv(exp(y(35)),(-params(1)),1);
T(53) = exp(y(35))*getPowerDeriv(exp(y(35)),(-(params(8)*(T(1)+T(2)))),1);
