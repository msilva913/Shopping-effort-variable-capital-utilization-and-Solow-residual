...
residual(14) = lhs - rhs;
lhs = y(18);
rhs = y(65)-y(37)+(y(59)-y(63)-y(66)-y(60))*params(2)*T(1)+params(2)*y(57);
residual(15) = lhs - rhs;
lhs = y(19);
rhs = y(65)-y(37)+(y(62)-y(64)-y(67)-y(61))*params(2)*T(1)+params(2)*y(58);
residual(16) = lhs - rhs;
lhs = y(34)+y(18)+y(38)+y(38)*params(4);
rhs = y(20)-y(21);
residual(17) = lhs - rhs;
lhs = y(35)+y(19)+y(39)+params(4)*y(39);
rhs = y(26)-y(22);
residual(18) = lhs - rhs;
lhs = y(18);
...
residual(21) = lhs - rhs;
lhs = y(20);
rhs = y(40)+y(13)+y(16)*T(7)*(1-T(4))+(y(34)+y(38))*T(2)+y(30)*T(3);
residual(22) = lhs - rhs;
lhs = y(26);
rhs = y(41)+y(14)+y(17)*T(7)*(1-T(4))+(y(35)+y(39))*T(2)+y(31)*T(3);
residual(23) = lhs - rhs;
lhs = y(24);
rhs = y(30)*T(3)+y(13)+y(40)+y(34)*T(2);
residual(24) = lhs - rhs;
lhs = y(25);
...
residual(40) = lhs - rhs;
lhs = y(53);
rhs = y(48)-(1-params(9))*y(36)-params(9)*y(33);
residual(41) = lhs - rhs;
lhs = y(54);
rhs = y(55)-(1-params(9))*y(36)-params(9)*y(33);
residual(42) = lhs - rhs;
lhs = y(52);
rhs = y(48)-y(33);
residual(43) = lhs - rhs;
