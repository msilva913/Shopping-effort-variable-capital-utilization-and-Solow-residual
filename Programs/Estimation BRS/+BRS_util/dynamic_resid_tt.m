...
T(2) = 1/params(4);
T(3) = exp(y(31))*y(35)^(1/params(9));
T(4) = 1+1/params(9);
T(5) = exp(y(31))*y(35)^T(4)/T(4);
T(6) = y(38)^(-params(1));
T(7) = y(66)^(-params(1));
T(8) = exp(y(68))^(-params(1));
T(9) = y(25)^((1-params(8))*params(7));
T(10) = y(26)^((1-params(8))*params(7));
...
T(17) = exp(y(30))*(1-params(8))*params(5)*(1-params(8))*params(7)*params(16)/(1-params(8))/(params(5)*params(17))/params(17)^T(2);
T(18) = y(24)^T(2)*T(17);
T(19) = y(24)^(1+T(2))*T(17)/(1+T(2));
T(20) = 1-(1+params(5)/params(6)-exp(params(3)));
T(21) = params(2)*((1-params(8))*y(64)+y(67)*T(20));
T(22) = y(36)^params(8)*T(12);
T(23) = exp(y(40))^(-T(11));
T(24) = exp(y(27))*T(15)*T(22)*T(23);
T(25) = y(1)^T(11);
T(26) = T(24)*T(25);
T(27) = y(37)^params(8)*T(13);
T(28) = T(23)*exp(y(29))*T(16)*T(27);
T(29) = y(2)^T(11);
T(30) = T(28)*T(29);
