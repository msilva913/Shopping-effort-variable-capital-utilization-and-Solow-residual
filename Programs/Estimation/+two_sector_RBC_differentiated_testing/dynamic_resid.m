...
rhs = y(26)+y(28);
residual(7) = lhs - rhs;
lhs = y(39)+1/params(5)*y(29);
rhs = y(26)+y(21)*(-params(6))-y(13);
residual(8) = lhs - rhs;
lhs = y(30);
...
residual(11) = lhs - rhs;
lhs = y(14);
rhs = y(53)-y(33)+y(52)*params(2)*T(1)+params(2)*y(49);
residual(12) = lhs - rhs;
lhs = y(15);
rhs = y(53)-y(33)+y(51)*params(2)*T(1)+params(2)*y(50);
residual(13) = lhs - rhs;
lhs = y(25);
...
residual(19) = lhs - rhs;
lhs = y(17);
rhs = T(4)*(y(28)*(1-T(3))+y(37)+(y(35)+y(31))*T(3));
residual(20) = lhs - rhs;
lhs = y(22);
rhs = T(4)*(y(27)*(1-T(3))+y(11)+y(36)+y(30)*T(3))-y(11)*(T(4)-1);
residual(21) = lhs - rhs;
lhs = y(23);
rhs = T(4)*(y(28)*(1-T(3))+y(37)+y(31)*T(3));
residual(22) = lhs - rhs;
lhs = y(29);
...
residual(29) = lhs - rhs;
lhs = y(39);
rhs = (params(14)+params(15))*y(9)+params(15)*(-params(14))*y(10)-x(it_, 3);
residual(30) = lhs - rhs;
lhs = y(41);
rhs = y(16)-y(11);
residual(31) = lhs - rhs;
...
residual(34) = lhs - rhs;
lhs = y(45);
rhs = y(40)-(1-params(9))*y(32)-params(9)*y(29);
residual(35) = lhs - rhs;
lhs = y(46);
rhs = y(47)-(1-params(9))*y(32)-params(9)*y(29);
residual(36) = lhs - rhs;
lhs = y(44);
rhs = y(40)-y(29);
residual(37) = lhs - rhs;
