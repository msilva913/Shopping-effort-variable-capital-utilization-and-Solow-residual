...
//L_obs,
 K_C, K_I, K, lam, cu,
% shock vars
Z, Z_I, u_ZI, chi, kappa,

%observables (4 series)
C_obs, I_obs, LC_obs, LI_obs, Y_obs, p_I_obs, lab_prod_obs, labor_share, SR_obs, w_obs;
...
Gamma_C =  phi*(0-rho)/Gamma_bar*(1-phi)*gam*q_C;
//Gamma_C = 0.0;

% 5)
[name = 'Markup (investment)']
Gamma_I = phi*(-rho)/Gamma_bar*(1-phi)*gam*q_I;
//Gamma_I = 0.0;
...
cu = phi_C*(phi*q_C) + phi_I*(phi*q_I);
...
%%%%%%%%%%%%%%%%%%%%
%varobs LC_obs, LI_obs, C_obs, I_obs;
varobs C_obs, I_obs, lab_prod_obs, p_I_obs;
%/*
estimated_params;
...
mode_file=directed_search_simp_mode, 
//load_mh_file, 
//mh_recover,
...
C_obs, I_obs, Y_obs, lab_prod_obs, labor_share, L_C, L_I, L, p_I_obs;
