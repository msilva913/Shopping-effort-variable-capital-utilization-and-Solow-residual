...
T(14) = (T(10)+(1-params(6))*(1-params(11))/params(18))/(T(13)*((1-params(6))*(1-params(11))*params(12)*exp(params(3)))^T(4)*((1-params(6))*(1-params(11))*params(30))^T(5));
T(15) = (T(11)+params(6)*(1-params(11))/params(18))/(T(13)*(params(6)*(1-params(11))*params(12)*exp(params(3)))^T(4)*(params(6)*(1-params(11))*params(30))^T(5));
T(16) = (T(12)+params(11)/params(18))/(T(13)*(params(11)*params(12)*exp(params(3)))^T(4)*(params(11)*params(30))^T(5));
T(17) = 1/params(4);
...
T(22) = (1-params(16))*params(13)/params(30)/(params(30)^T(17)*params(7))*exp(y(24));
T(23) = y(19)^T(17)*T(22);
T(24) = (y(18)/y(19))^params(19);
T(25) = (1-params(6))*y(57)^(-params(5));
T(26) = params(6)*y(58)^(-params(5));
T(27) = exp(y(25))*y(52)^(1/params(17));
T(28) = 1+1/params(17);
