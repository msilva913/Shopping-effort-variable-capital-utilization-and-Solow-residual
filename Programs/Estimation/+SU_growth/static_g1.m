...
if T_flag
    T = BRS_growth.static_g1_tt(T, y, x, params);
end
g1 = zeros(40, 40);
...
g1(5,21)=y(22)*T(31)-T(16)*T(18)*T(31);
...
g1(7,10)=(-(T(19)*T(24)));
g1(7,19)=(-(T(19)*T(23)*T(21)*exp(y(10))*T(6)*T(3)*getPowerDeriv(y(19),params(8),1)));
g1(7,23)=(-(T(19)*T(23)*T(20)*T(32)));
g1(8,3)=1;
g1(8,6)=(-(T(25)*T(27)*getPowerDeriv(y(6),T(1),1)));
g1(8,9)=(-(T(29)*getPowerDeriv(y(9),(1-params(8))*params(7),1)));
g1(8,12)=(-(T(25)*T(29)));
g1(8,20)=(-(T(25)*T(28)*T(21)*exp(y(12))*T(7)*T(4)*getPowerDeriv(y(20),params(8),1)));
g1(8,23)=(-(T(25)*T(28)*T(26)*T(32)));
g1(9,3)=exp(y(23));
