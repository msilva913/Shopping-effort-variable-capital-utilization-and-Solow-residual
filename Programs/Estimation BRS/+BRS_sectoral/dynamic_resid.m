...
residual(13) = lhs - rhs;
lhs = y(64)/T(18);
rhs = y(65)*(1-y(67)*y(57)-y(55))+T(15);
residual(14) = lhs - rhs;
lhs = y(64)/T(18);
rhs = y(66)*(1-y(68)*y(58)-y(56))+T(17);
residual(15) = lhs - rhs;
lhs = y(65);
rhs = T(13)*(y(95)*y(97)+y(104)*(1-y(99)));
residual(16) = lhs - rhs;
lhs = y(66);
rhs = T(13)*(y(96)*y(98)+y(105)*(1-y(100)));
residual(17) = lhs - rhs;
lhs = y(65)*y(53);
rhs = y(45);
residual(18) = lhs - rhs;
...
residual(19) = lhs - rhs;
lhs = y(51);
rhs = T(21)+(y(49)-1)*T(22)+(y(49)-1)^2*params(7)*T(22)/2;
residual(20) = lhs - rhs;
lhs = y(52);
rhs = T(21)+(y(50)-1)*T(22)+(y(50)-1)^2*params(8)*T(22)/2;
residual(21) = lhs - rhs;
lhs = y(53);
rhs = T(22)+(y(49)-1)*params(7)*T(22);
residual(22) = lhs - rhs;
lhs = y(54);
rhs = T(22)+(y(50)-1)*params(8)*T(22);
residual(23) = lhs - rhs;
lhs = y(27);
...
residual(27) = lhs - rhs;
lhs = y(47)*T(18);
rhs = T(24)*(y(27)+T(28)*T(40))/y(35);
residual(28) = lhs - rhs;
lhs = y(48)*T(18)/y(64);
rhs = T(24)*(y(28)+T(29)*T(45))/y(36);
residual(29) = lhs - rhs;
lhs = y(45)*T(18);
rhs = (y(27)+T(28)*T(40))*exp(y(71))*T(23)/(y(49)*y(4));
residual(30) = lhs - rhs;
lhs = y(46)*T(18)/y(64);
rhs = (y(28)+T(29)*T(45))*exp(y(71))*T(23)/(y(50)*y(5));
residual(31) = lhs - rhs;
lhs = y(34);
rhs = y(35)+y(36);
residual(32) = lhs - rhs;
