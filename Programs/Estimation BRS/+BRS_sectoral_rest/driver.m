...
M_.exo_names(6) = {'e_b'};
M_.exo_names_tex(6) = {'{e_b}'};
M_.exo_names_long(6) = {'Discount factor shock'};
M_.exo_names(7) = {'e_muC'};
M_.exo_names_tex(7) = {'{e_{muC}}'};
M_.exo_names_long(7) = {'Wage markup shock: C'};
M_.exo_names(8) = {'e_muI'};
M_.exo_names_tex(8) = {'{e_{muI}}'};
M_.exo_names_long(8) = {'Wage markup shock: I'};
...
M_.mapping.theta_b.eqidx = [27 28 29 30 31 32 68 ];
...
estim_params_.var_exo = [estim_params_.var_exo; 6, 0.01, 0.0001, 0.4, 2, 0.01, 0.01, NaN, NaN, NaN ];
