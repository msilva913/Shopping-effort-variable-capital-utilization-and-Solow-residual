...
rhs = y(33)+y(44);
residual(13) = lhs - rhs;
lhs = y(49)-y(24)*params(6);
rhs = y(16)+y(38);
residual(14) = lhs - rhs;
lhs = y(19);
rhs = y(67)-y(38)+(y(61)-y(65)-y(68)-y(62))*params(2)*T(1)+params(2)*y(59);
residual(15) = lhs - rhs;
lhs = y(20);
rhs = y(67)-y(38)+(y(64)-y(66)-y(69)-y(63))*params(2)*T(1)+params(2)*y(60);
residual(16) = lhs - rhs;
lhs = y(35)+y(39)+y(39)*params(4);
rhs = y(21)-y(22);
residual(17) = lhs - rhs;
lhs = y(36)+y(40)+params(4)*y(40);
rhs = y(27)-y(23);
residual(18) = lhs - rhs;
lhs = y(19);
rhs = params(3)*params(12)*(y(28)-y(35)-y(22));
residual(19) = lhs - rhs;
lhs = y(20);
rhs = params(3)*params(12)*(y(29)-y(36)-y(23));
residual(20) = lhs - rhs;
lhs = y(53);
rhs = y(15)-y(14);
residual(21) = lhs - rhs;
lhs = y(21);
rhs = y(41)+y(14)+y(17)*T(7)*(1-T(4))+(y(35)+y(39))*T(2)+y(31)*T(3);
residual(22) = lhs - rhs;
lhs = y(27);
rhs = y(42)+y(15)+y(18)*T(7)*(1-T(4))+(y(36)+y(40))*T(2)+y(32)*T(3);
residual(23) = lhs - rhs;
lhs = y(25);
rhs = y(31)*T(3)+y(14)+y(41)+y(35)*T(2);
residual(24) = lhs - rhs;
lhs = y(26);
rhs = y(32)*T(3)+y(15)+y(42)+y(36)*T(2);
residual(25) = lhs - rhs;
lhs = y(34);
...
residual(41) = lhs - rhs;
lhs = y(55);
rhs = y(50)-(1-params(9))*y(37)-params(9)*y(34);
residual(42) = lhs - rhs;
lhs = y(56);
rhs = y(57)-(1-params(9))*y(37)-params(9)*y(34);
residual(43) = lhs - rhs;
lhs = y(54);
rhs = y(50)-y(34);
residual(44) = lhs - rhs;
