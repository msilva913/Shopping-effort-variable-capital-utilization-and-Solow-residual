...
rho_Z,  0.6, 0.01, 0.9999999,        BETA_PDF, 0.6, 0.2;
...
stderr e_Z, 0.01, 0.0001, 0.2,  INV_GAMMA_PDF, 0.01, 0.1;
stderr e_N, 0.01, 0.0001, 0.2,  INV_GAMMA_PDF, 0.01, 0.1;
stderr e_D, 0.01, 0.0001, 2.0,  INV_GAMMA_PDF, 0.01, 0.1;
...
mode_file=BRS_est_shopping_mode, 
//load_mh_file, 
//mh_recover,
