...
options_ = [];
M_.fname = 'SU_sectoral_wo_fixed_cost';
...
options_.mode_file = 'SU_sectoral_wo_fixed_cost_mh_mode';
...
save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'SU_sectoral_wo_fixed_cost_results.mat'], 'options_mom_', '-append');
end
