...
residual(3) = lhs - rhs;
lhs = y(46);
rhs = y(20)-T(6)-T(8)*T(22)/T(7);
residual(4) = lhs - rhs;
lhs = y(48);
rhs = y(47)/T(10);
residual(5) = lhs - rhs;
lhs = y(48);
rhs = (y(71)*y(73)+(1-y(75))*y(78))*T(24);
residual(6) = lhs - rhs;
lhs = y(48);
rhs = (y(72)*y(74)+y(78)*(1-y(76)))*T(24);
residual(7) = lhs - rhs;
lhs = y(48)*y(41);
rhs = y(34);
residual(8) = lhs - rhs;
...
residual(11) = lhs - rhs;
lhs = y(41);
rhs = exp(y(33))*(T(1)+T(13)+(y(37)-1)*params(6)*(T(1)+T(13)));
residual(12) = lhs - rhs;
lhs = y(42);
rhs = exp(y(33))*(T(1)+T(13)+(y(38)-1)*params(6)*(T(1)+T(13)));
residual(13) = lhs - rhs;
lhs = y(20);
rhs = T(31)*T(32);
residual(14) = lhs - rhs;
...
residual(18) = lhs - rhs;
lhs = y(34)*T(10);
rhs = exp(y(50))*y(20)*params(9)*(T(1)+T(13))/(y(37)*y(1));
residual(19) = lhs - rhs;
lhs = y(35)*T(10)/y(47);
rhs = exp(y(50))*y(21)*params(9)*(T(1)+T(13))/(y(38)*y(2));
residual(20) = lhs - rhs;
lhs = y(25);
rhs = y(26)+y(27);
residual(21) = lhs - rhs;
...
residual(24) = lhs - rhs;
lhs = y(49);
rhs = T(11)*y(20)/y(19)*T(16)*T(37)+T(12)*y(21)/y(19)*T(17)*T(38);
residual(25) = lhs - rhs;
lhs = y(50);
