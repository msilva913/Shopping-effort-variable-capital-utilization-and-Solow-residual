...
residual(18) = lhs - rhs;
lhs = y(6);
rhs = params(3)*params(12)*(y(15)-y(22)-y(9));
residual(19) = lhs - rhs;
lhs = y(7);
rhs = params(3)*params(12)*(y(16)-y(23)-y(10));
residual(20) = lhs - rhs;
lhs = y(40);
rhs = y(2)-y(1);
residual(21) = lhs - rhs;
...
residual(35) = lhs - rhs;
lhs = y(36);
rhs = y(36)*params(18)-x(6);
residual(36) = lhs - rhs;
lhs = y(35);
rhs = (params(19)+params(20))*y(35)+params(20)*(-params(19))*y(35)-x(5);
residual(37) = lhs - rhs;
lhs = y(38);
rhs = y(8)-y(1);
residual(38) = lhs - rhs;
