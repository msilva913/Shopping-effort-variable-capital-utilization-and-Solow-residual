...
if T_flag
    T = SU_util.static_resid_tt(T, y, x, params);
end
residual = zeros(53, 1);
    ...
    residual(37) = (y(37)) - (log(y(23))-(log(y(23))));
    residual(38) = (y(38)) - (log(y(27))-(log(y(27))));
    residual(39) = (y(39)) - (log(y(25))-(log(y(25))));
    residual(40) = (y(40)) - (log(y(26))-(log(y(26))));
    residual(41) = (y(41)) - (y(24)-params(3));
    residual(42) = (y(42)) - (y(24)-params(3));
    residual(43) = (y(43)) - (y(24)-params(3));
    residual(44) = (y(44)) - (y(24)-params(3));
    residual(45) = (y(45)) - (params(7)*(y(24)-params(3)));
residual(46) = y(46);
residual(47) = y(49);
residual(48) = y(47);
residual(49) = y(48);
