...
T(34) = y(83)^params(15);
T(35) = T(33)*T(34);
T(36) = (1-params(7))*y(122)^(-params(6));
T(37) = params(7)^(1-T(1));
T(38) = (1-params(7))^(1-T(1));
T(39) = T(37)*y(69)^T(1)+T(38)*y(68)^T(1);
T(40) = y(80)^T(2);
T(41) = y(81)^T(2);
T(42) = y(83)^T(2);
...
T(58) = y(82)^(1+params(21))*T(56)+y(83)^(1+params(21))*T(57);
T(59) = exp(y(88))*(1-params(18))*params(15)/params(32)/(params(8)*params(32)^T(5)*((1-params(13))*(1-params(17))-(T(3))^T(4)/T(4)));
T(60) = y(84)^T(5)*T(59);
T(61) = y(84)^(1+T(5))*T(59)/(1+T(5));
T(62) = y(121)*T(61);
T(63) = params(9)*T(44)/2;
T(64) = y(117)^params(18)*T(46);
T(65) = T(15)^(-T(45));
T(66) = exp(y(85))*T(53)*T(65);
T(67) = (y(100)*y(5))^T(45);
T(68) = T(66)*T(67);
T(69) = T(64)*(T(40)*T(68)-T(49));
T(70) = y(118)^params(18)*T(47);
T(71) = exp(y(85))*T(54)*T(65);
T(72) = (y(101)*y(6))^T(45);
T(73) = T(71)*T(72);
T(74) = T(70)*(T(41)*T(73)-T(50));
T(75) = y(119)^params(18)*T(48);
T(76) = exp(y(87))*T(55)*T(65);
T(77) = (y(102)*y(7))^T(45);
T(78) = T(76)*T(77);
