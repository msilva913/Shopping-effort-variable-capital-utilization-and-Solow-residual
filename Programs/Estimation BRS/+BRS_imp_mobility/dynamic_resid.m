...
if T_flag
    T = BRS_imp_mobility.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(55, 1);
lhs = y(32);
...
residual(4) = lhs - rhs;
lhs = y(51);
rhs = exp(y(38))*y(24)-T(6)-T(8)*T(32)/T(7)-params(13)*y(52);
residual(5) = lhs - rhs;
lhs = y(52);
...
residual(14) = lhs - rhs;
lhs = y(46);
rhs = T(1)+T(21)+(y(42)-1)*params(5)*(T(1)+T(21));
residual(15) = lhs - rhs;
lhs = y(47);
rhs = T(1)+T(21)+(y(43)-1)*params(5)*(T(1)+T(21));
residual(16) = lhs - rhs;
lhs = y(24);
rhs = T(41)*T(42);
residual(17) = lhs - rhs;
...
residual(18) = lhs - rhs;
lhs = y(25)*exp(y(57));
rhs = exp(y(57))*(y(27)+y(28))-y(3)*(1-y(44))-y(4)*(1-y(45))+T(13)*(y(55)-params(7)/params(8))^2;
residual(19) = lhs - rhs;
lhs = y(41)*T(14);
rhs = y(24)*params(9)*T(14)/y(30);
residual(20) = lhs - rhs;
lhs = y(41)*T(14)/y(53);
rhs = y(25)*params(9)*T(14)/y(31);
residual(21) = lhs - rhs;
lhs = y(39)*T(14);
rhs = exp(y(57))*y(24)*params(8)*(T(1)+T(21))/(y(42)*y(3));
residual(22) = lhs - rhs;
lhs = y(40)*T(14)/y(53);
rhs = exp(y(57))*y(25)*params(8)*(T(1)+T(21))/(y(43)*y(4));
residual(23) = lhs - rhs;
lhs = y(29);
rhs = y(30)+y(31);
residual(24) = lhs - rhs;
...
residual(26) = lhs - rhs;
lhs = y(23);
rhs = y(24)+params(21)*y(25);
residual(27) = lhs - rhs;
lhs = y(56);
rhs = T(19)*y(24)/y(23)*T(23)*T(47)+T(20)*y(25)/y(23)*T(24)*T(48);
residual(28) = lhs - rhs;
lhs = y(57);
rhs = params(3)*(1-params(15))+params(15)*y(12)+x(it_, 1);
residual(29) = lhs - rhs;
lhs = y(33);
...
residual(45) = lhs - rhs;
lhs = y(68);
rhs = y(57)+y(59)-y(14)-params(3);
residual(46) = lhs - rhs;
lhs = y(69);
rhs = y(57)+y(60)-y(15)-params(3);
residual(47) = lhs - rhs;
lhs = y(70);
rhs = y(57)+y(58)-y(13)-params(3);
residual(48) = lhs - rhs;
lhs = y(71);
rhs = y(57)+y(64)-y(19)-params(3);
residual(49) = lhs - rhs;
lhs = y(72);
rhs = y(66)-y(21);
residual(50) = lhs - rhs;
