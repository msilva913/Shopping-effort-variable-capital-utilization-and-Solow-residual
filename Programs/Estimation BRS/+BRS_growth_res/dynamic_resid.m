...
if T_flag
    T = BRS_growth_res.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(36, 1);
lhs = T(22);
rhs = y(30)*(1-T(2));
...
residual(6) = lhs - rhs;
lhs = y(15);
rhs = T(26)*(T(30)*T(31)-T(16));
residual(7) = lhs - rhs;
lhs = y(16);
rhs = T(32)*(T(35)*T(36)-T(17));
residual(8) = lhs - rhs;
lhs = y(16)*exp(y(36));
rhs = exp(y(36))*(y(18)+y(19))-(y(1)+y(2))*T(24);
residual(9) = lhs - rhs;
lhs = y(30)*(1-T(2));
rhs = T(11)*(y(15)+T(16)*T(26))/y(21);
residual(10) = lhs - rhs;
lhs = y(28)*(1-T(2));
rhs = (y(15)+T(16)*T(26))*exp(y(36))*T(12)/y(1);
residual(11) = lhs - rhs;
lhs = y(30)*(1-T(2))/y(35);
rhs = T(11)*(y(16)+T(17)*T(32))/y(22);
residual(12) = lhs - rhs;
lhs = y(29)*(1-T(2))/y(35);
rhs = exp(y(36))*T(12)*(y(16)+T(17)*T(32))/y(2);
residual(13) = lhs - rhs;
lhs = y(20);
rhs = y(21)+y(22);
residual(14) = lhs - rhs;
