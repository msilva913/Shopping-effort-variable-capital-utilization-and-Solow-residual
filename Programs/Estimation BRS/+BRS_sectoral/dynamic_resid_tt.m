...
T(2) = 1+1/params(17);
T(3) = 1/params(5);
T(4) = (y(55)/y(57))^params(19);
T(5) = (y(56)/y(57))^params(19);
T(6) = exp(y(62))*y(79)^(1/params(17));
T(7) = exp(y(62))*y(79)^T(2)/T(2);
T(8) = y(47)-params(15)*y(1)-T(7);
T(9) = T(8)^params(6);
T(10) = y(12)^(1-params(6));
T(11) = params(3)*exp(y(64))*(y(143)/y(82))^(-params(1));
T(12) = exp(y(148))^(-params(1));
T(13) = T(11)*T(12);
T(14) = y(146)^2;
T(15) = T(13)*y(144)*y(141)*T(14);
T(16) = y(147)^2;
T(17) = T(13)*y(145)*y(142)*T(16);
T(18) = 1-T(1);
T(19) = y(80)^T(1);
T(20) = y(81)^T(1);
...
T(35) = y(55)^(1+params(19))*T(33)+y(56)^(1+params(19))*T(34);
T(36) = exp(y(61))*params(13)/params(28)*T(18)/(params(28)^T(3)*((1-params(11))*(1-params(15))-(T(25))^T(2)/T(2)));
T(37) = y(57)^T(3)*T(36);
T(38) = y(57)^(1+T(3))*T(36)/(1+T(3));
T(39) = y(83)*T(38);
T(40) = T(19)*T(26);
T(41) = exp(y(91))^(-T(23));
T(42) = exp(y(58))*T(31)*T(41);
T(43) = (y(69)*y(4))^T(23);
T(44) = y(55)^T(24);
T(45) = T(20)*T(27);
T(46) = exp(y(60))*T(32)*T(41);
T(47) = (y(70)*y(5))^T(23);
T(48) = y(56)^T(24);
T(49) = T(19)*y(47)/y(46)*T(26);
T(50) = T(49)*(T(43)*T(44)-T(28));
T(51) = y(4)^T(23);
T(52) = T(44)*T(51)-T(28);
T(53) = T(20)*y(48)/y(46)*T(27);
