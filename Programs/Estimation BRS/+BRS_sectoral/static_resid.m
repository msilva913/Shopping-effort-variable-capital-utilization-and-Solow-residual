...
residual(40) = lhs - rhs;
lhs = (1-T(3))*y(30)/y(53);
rhs = T(6)*(y(4)+T(12)*T(53))/y(14);
residual(41) = lhs - rhs;
lhs = (1-T(3))*y(31)/y(54);
rhs = T(6)*(y(5)+T(13)*T(58))/y(16);
residual(42) = lhs - rhs;
lhs = (1-T(3))*y(27)/y(52);
rhs = (y(3)+T(11)*T(46))*T(5)*exp(y(66))/(y(33)*y(9));
residual(43) = lhs - rhs;
lhs = (1-T(3))*y(28)/y(53);
rhs = (y(4)+T(12)*T(53))*T(5)*exp(y(66))/(y(34)*y(10));
residual(44) = lhs - rhs;
lhs = (1-T(3))*y(29)/y(54);
rhs = (y(5)+T(13)*T(58))*T(5)*exp(y(66))/(y(35)*y(11));
residual(45) = lhs - rhs;
lhs = y(12);
rhs = y(16)+y(13)+y(14);
residual(46) = lhs - rhs;
...
residual(55) = lhs - rhs;
lhs = y(66);
rhs = x(3)+params(3)*(1-params(22))+y(66)*params(22)+x(1)+x(2);
residual(56) = lhs - rhs;
lhs = y(18);
rhs = x(6)+y(18)*params(23)+x(4)+x(5);
residual(57) = lhs - rhs;
lhs = y(19);
rhs = x(9)+y(20)*params(24)+x(7)+x(8);
residual(58) = lhs - rhs;
lhs = y(20);
rhs = y(18)+y(19);
residual(59) = lhs - rhs;
lhs = y(21);
rhs = y(21)*params(25)-x(10);
residual(60) = lhs - rhs;
lhs = y(22);
rhs = y(22)*params(26)-x(11)-x(12)-x(13);
residual(61) = lhs - rhs;
lhs = y(23);
rhs = y(23)*params(27)-x(14)-x(15)-x(16);
residual(62) = lhs - rhs;
lhs = y(24);
rhs = x(19)+y(24)*params(28)+x(17)+x(18);
residual(63) = lhs - rhs;
lhs = y(25);
rhs = x(22)+y(25)*params(29)+x(20)+x(21);
residual(64) = lhs - rhs;
lhs = y(26);
rhs = x(25)+y(26)*params(30)+x(23)+x(24);
residual(65) = lhs - rhs;
lhs = y(67);
rhs = log(y(1))-(log(y(1)));
residual(66) = lhs - rhs;
