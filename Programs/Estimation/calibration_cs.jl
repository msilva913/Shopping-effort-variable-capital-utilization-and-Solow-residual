...
using Parameters, CSV, Statistics
using PlotlyJS
using MAT
...
@with_kw mutable struct Targets
    ...
    # Parameters to be estimated: place initial values
...
# Load posterior mean
posterior_mean_dict = matread("posterior_mean.mat")
posterior_mean = posterior_mean_dict["posterior_mean"]
