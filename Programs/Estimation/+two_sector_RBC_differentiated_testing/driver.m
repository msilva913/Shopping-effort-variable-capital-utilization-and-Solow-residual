...
options_ = [];
M_.fname = 'two_sector_RBC_differentiated_testing';
...
M_.endo_names(39) = {'AUX_ENDO_LAG_28_1'};
M_.endo_names_tex(39) = {'AUX\_ENDO\_LAG\_28\_1'};
M_.endo_names_long(39) = {'AUX_ENDO_LAG_28_1'};
...
M_.mapping.chi.eqidx = [8 30 ];
M_.mapping.Y_obs.eqidx = [33 35 37 38 ];
M_.mapping.C_obs.eqidx = [31 ];
M_.mapping.TI_obs.eqidx = [32 ];
M_.mapping.p_I_obs.eqidx = [18 ];
M_.mapping.lab_prod_obs.eqidx = [37 ];
M_.mapping.labor_share.eqidx = [38 ];
M_.mapping.SR_obs.eqidx = [35 ];
M_.mapping.SR_util_obs.eqidx = [36 ];
M_.mapping.Y_util_obs.eqidx = [34 36 ];
M_.mapping.e_Z.eqidx = [27 ];
M_.mapping.e_ZI.eqidx = [28 ];
M_.mapping.e_chi.eqidx = [30 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [8 9 11 20 21 24 25 26 28 29 39 ];
...
save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'two_sector_RBC_differentiated_testing_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
