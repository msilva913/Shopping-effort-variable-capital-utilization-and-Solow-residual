...
options_.varobs_id = [ 92 93 85 86 90 94 95  ];
M_ = setup_solvers(M_);
...
M_.state_var = [2 7 8 9 11 12 13 20 22 23 24 25 26 64 69 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 ];
...
estim_params_.param_vals = [estim_params_.param_vals; 1, 2.0, 1.0, 4.0, 1, 1.5, 0.25, 1.0, 4.0, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 16, 0.6, 0.00, 0.999, 1, 0.32, 0.2, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 14, 0.30, 0.01, 0.5, 1, 0.2, 0.1, NaN, NaN, NaN ];
