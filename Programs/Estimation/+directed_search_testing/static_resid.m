...
residual(5) = lhs - rhs;
lhs = y(20)+y(21);
rhs = y(8)-y(13)+T(14)*(y(1)+T(10)*y(4)-y(8));
residual(6) = lhs - rhs;
lhs = y(20)+y(22);
rhs = y(9)-y(14)+T(14)*(y(2)+T(10)*y(5)-y(9));
residual(7) = lhs - rhs;
lhs = y(19)+y(28)+y(24);
rhs = y(20)+y(21);
residual(8) = lhs - rhs;
...
rhs = y(20)+y(22);
residual(9) = lhs - rhs;
lhs = y(32)+1/params(5)*y(23);
rhs = y(20)+y(15)*(-params(6))-y(3);
residual(10) = lhs - rhs;
lhs = y(24);
...
residual(14) = lhs - rhs;
lhs = y(3)+y(27);
rhs = y(15)*(-params(6))+(y(12)-y(8))*T(15);
residual(15) = lhs - rhs;
lhs = y(6);
...
residual(23) = lhs - rhs;
lhs = y(9);
rhs = T(6)*(y(30)+y(2)+T(10)*y(5)*(1-T(5))+T(3)*(y(29)+y(25))+T(4)*y(22))-(T(6)-1)*(y(2)+T(10)*y(5));
residual(24) = lhs - rhs;
lhs = y(16);
rhs = T(6)*(T(4)*y(21)+y(1)+y(30)+T(3)*y(24))-(T(6)-1)*y(1);
residual(25) = lhs - rhs;
lhs = y(17);
rhs = T(6)*(T(4)*y(22)+y(2)+y(30)+T(3)*y(25))-(T(6)-1)*y(2);
residual(26) = lhs - rhs;
lhs = y(23);
...
residual(30) = lhs - rhs;
lhs = y(30);
rhs = y(30)*params(14)+x(1);
residual(31) = lhs - rhs;
lhs = y(31);
rhs = y(31)*params(16)-x(2);
residual(32) = lhs - rhs;
lhs = y(32);
rhs = (params(18)+params(19))*y(32)+params(19)*(-params(18))*y(32)-x(3);
residual(33) = lhs - rhs;
lhs = y(34);
rhs = y(8)-y(1);
residual(34) = lhs - rhs;
