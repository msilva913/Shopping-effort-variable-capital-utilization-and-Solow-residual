...
% Equation 68
\begin{dmath}
{{\theta_I}}_{t}={{\rho_{DI}}}\, {{\theta_I}}_{t-1}-{{e_{DI}}}_{t}
\end{dmath}
% Equation 69
\begin{dmath}
...
% Equation 96
\begin{dmath}
{tech\_obs}_{t}={log\_tech}_{t}-{log\_tech}_{t-1}+\left({{g}}_{t}-{{\overline{g}}}\right)\, \left(1-\frac{{{K_Y}}\, \left(\frac{\exp\left({{\overline{g}}}\right)^{{{\sigma}}}}{{{\beta}}}-1+1+\frac{{{I_Y}}}{{{K_Y}}}-\exp\left({{\overline{g}}}\right)\right)}{1+{{\nu_R}}}\right)
\end{dmath}
% Equation 97
\begin{dmath}
