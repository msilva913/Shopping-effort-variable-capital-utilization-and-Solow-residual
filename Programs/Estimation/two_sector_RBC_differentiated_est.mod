...
Y_obs, C_obs, TI_obs, LI_obs, p_I_obs, lab_prod_obs, labor_share, SR_obs,
...
C_util = (1+nu_R)*(p_C + Z + alpha*(K_C)+(1-alpha)*L_C)-nu_R*(p_C);
...
mode_file=two_sector_RBC_differentiated_est_mode, 
load_mh_file, 
//mh_recover,
